...
if (game.VIPServerId ~= "" and game.VIPServerOwnerId == 0) then
	...
	--	local ShutdownMessage = player.PlayerGui:FindFirstChild("ShutdownMessage") assert(ShutdownMessage, "Shutdown UI not found!")
	--	if not ShutdownMessage then continue end
	--	ShutdownMessage.Enabled = true
	--end
	...
	game:BindToClose(function()
		...
		local m = Instance.new("Message")
		m.Text = "Rebooting servers for update. Please wait (DATA WILL BE SAVED)"
		m.Parent = workspace
		wait(2)
